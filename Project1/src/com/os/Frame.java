...
public class Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Team: 20200319, 20200334, 20200465, 20200538");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        String nameFile = jTextArea3.getText();
        Constants.creteFile(nameFile);



        synchronized (this) {
            try {
                Constants.size = (Integer.parseInt(jTextArea2.getText()));
                Constants.primeNumber = Integer.parseInt(jTextArea1.getText());
            } catch (Exception e) {

            }

            Constants.start = System.currentTimeMillis();
            Buffer buf = new Buffer(Constants.size);
